...
void ::uwp_hello_world::MainPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::uwp_hello_world::MainPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::uwp_hello_world::MainPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
