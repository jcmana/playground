...
public:
    ...
    atomic_link_element(const atomic_link_element & other) = delete;
    atomic_link_element(atomic_link_element && other);

    ~atomic_link_element();

    atomic_link_element & operator  =(const atomic_link_element & other) = delete;
    atomic_link_element & operator  =(atomic_link_element && other);
...
atomic_link_element::atomic_link_element(atomic_link_element && other) :
    atomic_link_element()
{
    swap(*this, other);
}
...
atomic_link_element & atomic_link_element::operator  =(atomic_link_element && other)
{
